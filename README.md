[![REUSE status](https://api.reuse.software/badge/github.com/open-component-model/ocm-e2e-framework)](https://api.reuse.software/info/github.com/open-component-model/ocm-e2e-framework)
# OCM e2e Framework
