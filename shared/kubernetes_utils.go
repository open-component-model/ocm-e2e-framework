...
// RestartDeployment Restarts registry deployment, waits for new deployment to exist and for old pod to exit
func RestartDeployment(name string) env.TestFunc {
